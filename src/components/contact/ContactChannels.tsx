        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {bookingLinks?.airbnb && (
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-lg bg-[#FF385C] px-6 py-3.5 font-sans text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#E31C5F] active:scale-[0.98]"
            >
          ...
          {bookingLinks?.booking && (
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-lg bg-[#006CE4] px-6 py-3.5 font-sans text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#0057b8] active:scale-[0.98]"
            >
        ...
        {(email || phone) && (
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-10">
            {email && (
              <a
                href={`mailto:${email}`}
                className="group inline-flex items-center gap-2.5 font-sans text-foreground/80 transition-colors hover:text-primary-600"
              >
                <Mail className="h-4 w-4 text-primary-500" aria-hidden="true" />
                <span className="data text-sm">{email}</span>
              </a>
            )}
            {phone && (
              <ProtectedPhone
                encoded={Buffer.from(phone, "utf8").toString("base64")}
                className="group inline-flex items-center gap-2.5 font-sans text-foreground/80 transition-colors hover:text-primary-600"
                iconClassName="text-primary-500"
                textClassName="data text-sm"
              />
            )}
          </div>
        )}
